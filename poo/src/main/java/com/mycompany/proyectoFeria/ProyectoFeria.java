...
public class ProyectoFeria {
    ...
    public static void cargarFeria(){
        ...
        Emprendedor e1=new Emprendedor("0914463815","Emprendimiento1", "0981383239","jaescala@espol.edu.ec","Jaime",redes,"Emprendimiento");
        ...
        Emprendedor e2=new Emprendedor("09506375557","Emprendimiento2", "0968933048","gabareyue@espol.edu.ec","Gabriel",redes,"Emprendimiento");
        ...
        Emprendedor e4=new Emprendedor("0993939393","Emprendimiento3", "0978989632","natoledo@espol.edu.ec","Newton",redes,"Emprendimiento");
        ...
        Auspiciante auspiciante = new Auspiciante("09121212", "ESPOL", "1234567891", "pieroaraujo@espol.edu.ec", "Piero", redes, TipoServicio.ALIMENTACIÓN);
